...
public class UserListener implements Runnable {
    ...
    public void sendMessage(String message, String receiverId) throws IOException {
        Message messageAsObject = new Message.Builder().withText(message).withSenderId(this.userId)
                .withReceiverId(receiverId).withMessageType(MessageType.TEXT).build();
    ...
    private void sendLoginRequest() throws IOException {
        ...
        Message loginMessage = new Message.Builder().withSenderId(this.userId)
                .withMessageType(MessageType.USER_LOGIN_REQUEST).build();
